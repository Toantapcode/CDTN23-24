            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 wow animate__animated animate__fadeInDown">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        />
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Phòng VIP</h3>
                        <p className="text-gray-600 mb-4">Phòng rộng rãi và sang trọng với tầm nhìn ra biển.</p>
                        <button onClick={handleClick} className="bg-yellow-600 text-white px-6 py-3 rounded-lg hover:bg-yellow-700 uppercase font-bold tracking-widest">
                            Đặt ngay
                        </button>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        <img
                            ...
                            className="rounded-lg mb-4"
                        />
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Phòng Couple</h3>
                        <p className="text-gray-600 mb-4">Các phòng cặp đôi sang trọng với ban công riêng.</p>
                        <button onClick={handleClick} className="bg-yellow-600 text-white px-6 py-3 rounded-lg hover:bg-yellow-700 uppercase font-bold tracking-widest">
                            Đặt ngay
                        </button>
                    </div>
